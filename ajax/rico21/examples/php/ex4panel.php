...
Rico.onLoad( function() {
  ...
  grids[0]=new Rico.LiveGrid ('customergrid', new Rico.Buffer.AjaxSQL('ricoXMLquery.php'), opts);
  ...
  grids[1]=new Rico.LiveGrid ('ordergrid', new Rico.Buffer.AjaxSQL('ricoXMLquery.php'), opts);
  ...
  grids[2]=new Rico.LiveGrid ('detailgrid', new Rico.Buffer.AjaxSQL('ricoXMLquery.php'), opts);
