...
<?php// include_once 'includes/balaoInformativo.php';?>	
</head>
...
<body>
   ...
   <?php 
    ...
    <section style="clear:both;">
	 ...
	 echo "<header>
			<figure id='upvendas'>
        	<img src='imagens/upvendas.png' alt='Upvendas|1.1' title='Upvendas|1.1'/>
        </figure>
         ...
         if($_GET["pg"]=="cadastre"){
          echo "  <div id='legend'><h3 style='color: #fff;'>Cadastro</h3></div><br/><br/>";
                ...
                include("login.php");
                 ...
                 echo "<a href='?pg=cadastre'><div class='cadastrese'></div></a>";
            }
         } 
      ?> 
